...
def detect_language_deprecated(sentence, *, low_memory: bool = True):
    """
    Detect language code (deprecated)
    :param sentence: str sentence
    :param low_memory: bool (default: True) whether to use low memory mode
    :return: ZH, EN, JA, KO, FR, DE, ES, .... (two uppercase letters)
    """
    logging.warning("The function `detect_language_deprecated` is deprecated. Use `detect_language_code` instead.")
